 ...
 *
 * К этому скрипту обращается ЮKassa в процессе оплаты
 */
...
$shop_id = $settings['yoomoney_shopid'];
...
$str = $_POST['action'] . ';' . $_POST['orderSumAmount'] . ';' .
    ...
    $settings['yoomoney_shopid'] . ';' . $invoice_id . ';' .
    $_POST['customerNumber'] . ';' . $settings['yoomoney_password'];
