...
class YooMoneyFastPay extends Simpla
{
    const QUICK_PAY_VERSION = 2;
    const ORDER_PLACEHOLDER = '%order_id%';
    const FAST_PAY_URL = 'https://yoomoney.ru/fastpay/confirm';
    ...
    public function checkout_form($order_id, $button_text = null)
    {
        ...
        $narrative = $settings['yoomoney_fast_pay_narrative'];
        ...
        $form = '<form action="'. self::FAST_PAY_URL .'" method="post">
                    <input type="hidden" name="formId" value="' . $settings['yoomoney_fast_pay_id'] . '">
